...
{
    public function __construct(User $user,Collection $detail)
    {
        $this->user = $user;
    ...
    public function view(): View
    {
        ...
        return view('kpi.SelfEvaluation.Excel.excelevaluatequarter',['rules' => $this->rules, 'user' => $this->user, 'quarter_weight' => $quarter_weight]);
    }
}
