...
class User extends Authenticatable implements MustVerifyEmail, TranslatableContract
{
     ...
     */
    protected $fillable = [
        'name_th', 'name_en', 'head_id', 'email', 'phone', 'username', 'password', 'department_id', 'incentive_type', 'locale', 'divisions_id', 'positions_id', 'resigned', 'degree', 'image','email_verifed_at'
    ];
