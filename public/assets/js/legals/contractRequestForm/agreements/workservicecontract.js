...
const form = document.getElementById('form-workservicecontract');
...
async function logSubmit(event) {
    ...
    try {
        ...
        if (onSubmit && document.getElementById('form-workservicecontract').checkValidity()) {
            document.getElementById('form-workservicecontract').submit()
        }
        toastClear()
    }
}
