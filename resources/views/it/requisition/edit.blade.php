...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>{{ __('itstock.requisition-accessorie.requisition-edit') }}
...
<div class="col-lg-12">
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate action="{{route('it.equipment.requisition.update',$transaction->id)}}" method="POST"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="trans_by" id="validationTrans_by" class="form-control-sm form-control select2" required>
                            ...
                            <option value="{{$item->id}}" {{$transaction->trans_by == $item->id ? 'selected' : ''}}>{{$item->{'name_'.app()->getLocale()} }}</option>
                            @endforeach
                        </select>
                        <div class="valid-feedback">
                            Looks good!
                ...
                <div class="form-group">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="invalidCheck">
                            {{ __('itstock.requisition-accessorie.cancel-requisition') }}
                        </label>
                ...
                <button class="btn btn-primary" type="submit" style="margin-top: 5px">{{ __('itstock.requisition-accessorie.submit-form') }}</button>
            </form>
