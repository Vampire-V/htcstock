    ...
    <div class="main-card mb-3 card">
        ...
        <div class="form-row">
            <div class="col-md-4 mb-3">
                ...
                <select id="validationRuleType" class="form-control-sm form-control" name="kpi_rule_types_id" required>
                    <option value="">Choose...</option>
                    @isset($rulesType)
            ...
            <div class="col-md-4 mb-3">
                ...
                <select id="validationUserActual" class="form-control-sm form-control" name="user_actual" required>
                    <option value="">Choose...</option>
                    @isset($users)
            ...
            <div class="col-md-4 mb-3">
                <div class="position-relative form-group"><label for="Calculate-type" class="">Calculate
                        Type
                        :</label>
                    <select id="validationCalculateType" class="form-control form-control-sm" name="calculate_type"
                        placeholder="Calculate Type" required>
                        <option value="">Choose...</option>
                        @isset($calcuTypes)
        ...
        <div class="form-row">
            <div class="col-md-4">
                <label for="ruleName">Rule Name :</label>
                <input type="text" class="form-control form-control-sm" id="ruleName" placeholder="Rule Name"
                    name="name" required>
            </div>
            <div class="col-md-4">
                <label for="ruleCategory">Rule Category :</label>
                <select id="validationRuleCategory" class="form-control-sm form-control" name="category_id" required>
                    <option value="">Choose...</option>
                    @isset($category)
        ...
        <div class="form-row">
            ...
            <div class="col-md-4">
                <div class="position-relative form-group"><label for="DataSources" class="">DataSources
                        :</label>
                    <select id="validationDataSources" class="form-control form-control-sm" name="department_id"
                        required>
                        <option value="">Choose...</option>
                        @isset($departments)
        ...
        <div class="form-row">
            <div class="col-md-4">
                ...
                <input type="number" class="form-control form-control-sm" id="base_line" name="base_line" min="0.00"
                    step="0.01" required>
            </div>
            <div class="col-md-4">
                <label for="Max">Max :</label>
                <input type="number" class="form-control form-control-sm" id="max" name="max" min="0.00" step="0.01"
                    required>
            </div>
        </div>
        <div class="form-row">
