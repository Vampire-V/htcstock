...
<body>
    ...
    <div class="content">
        ...
        <h4 class="text-center">Purchase Equipment and Installation</h4>
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                <tr>
                    ...
                    <td class="text-rigth" style="width: 10%;">BOQ :</td>
                    <td>
                        <font><input type="checkbox" {{$contract->legalContractDest->boq ? "checked" : ""}}>
                        </font>
                    </td>
                </tr>
                <tr>
