    ...
    <div class="content">
        ...
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                ...
                <tr>
                    <td colspan="2" class="text-rigth">Working Day :</td>
                    <td colspan="2" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->working_day : ""}}
                        </font>
                    </td>
                    <td class="text-rigth">Working Time :</td>
                    <td colspan="4" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->working_time : ""}}
                        </font>
                    </td>
                </tr>
            </tbody>
        ...
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                <tr>
                    ...
                    <td class="text-rigth" style="width: 15%;">
                        <h5 class="underline">Number of maid :</h5>
                    </td>
                    <td class="text-rigth" >
                        Road :
                    </td>
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->road : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    <td class="text-center" style="width: 20%;"></td>
                    <td class="text-rigth" style="width: 15%;"></td>
                    <td class="text-rigth" >
                        Building :
                    </td>
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->building : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->toilet : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->canteen : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->washing : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->water : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->mowing : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="6" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->general : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
