    ...
    <div class="content">
        ...
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                <tr>
                    ...
                    <td class="text-rigth" style="width: 25%;">Security Service Certification :</td>
                    <td>
                        <font><input type="checkbox"
                                {{$contract->legalContractDest->security_service_certification ? "checked" : ""}}>
                        </font>
                    </td>
                </tr>

                <tr>
                    <td class="text-rigth" colspan="2">Security Guard License :</td>
                    <td>
                        <font><input type="checkbox"
                                {{$contract->legalContractDest->security_guard_license ? "checked" : ""}}>
                        </font>
                    </td>
                </tr>
            </tbody>
        ...
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                ...
                <tr>
                    <td colspan="2" class="text-rigth">Number of sercurity guard :</td>
                    <td colspan="7" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->number_of_sercurity_guard : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
