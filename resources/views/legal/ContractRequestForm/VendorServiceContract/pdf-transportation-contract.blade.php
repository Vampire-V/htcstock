    ...
    <div class="content">
        ...
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                ...
                <tr>
                    <td colspan="2" class="text-rigth">Route :</td>
                    <td colspan="2" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->route : ""}}
                        </font>
                    </td>
                    <td class="text-rigth">To :</td>
                    <td colspan="4" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->to : ""}}
                        </font>
                    </td>
                </tr>

                <tr>
                    <td colspan="2" class="text-rigth">Dry Container Size :</td>
                    <td colspan="7" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->dry_container_size : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="text-rigth">The number of truck :</td>
                    <td colspan="7" style="padding-left: 1%;">
                        <font class="underline">
                            {{isset($contract->legalContractDest->legalComercialTerm) ? $contract->legalContractDest->legalComercialTerm->the_number_of_truck : ""}}
                        </font>
                    </td>
                </tr>
                <tr>
        ...
        <table style="width: 95%; margin: 0 auto;">
            <tbody>
                <tr>
                    ...
                    <td>
                        <font class="underline">
                            {{$contract->legalContractDest->legalPaymentTerm->price_of_service}}
                        </font>
                    </td>
                </tr>
            </tbody>
